...
// Bucket para implantação de propostas
...
const MAX_BYTES = 7 * 1024 * 1024 // 7MB por arquivo (mesmo limite de solicitacoes)
  ...
  try {
    ...
    if (!process.env.SUPABASE_SERVICE_ROLE_KEY) {
      return NextResponse.json(
        { message: 'SERVICE_ROLE ausente para gerar URL assinada' },
        { status: 500 }
      )
    }
