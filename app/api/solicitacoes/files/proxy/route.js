...
// GET /api/solicitacoes/files/proxy?bucket=...&path=...
// Redireciona para URL pública (se bucket público) ou gera URL assinada temporária
export async function GET(request) {
  ...
  try {
    ...
    // Caso bucket seja privado, tenta URL assinada (requer service role configurado)
