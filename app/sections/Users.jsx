        ...
        <Dialog open={isUserDialogOpen} onOpenChange={setIsUserDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Adicione um novo usuário (gestor, gerente, analista de implantação, analista de movimentação, analista cliente ou consultor).</DialogDescription>
            </DialogHeader>
