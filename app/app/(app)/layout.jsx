        ...
        <Header
          ...
          leftSlot={
            <div className="md:hidden">
              <MobileSidebar currentUser={currentUser} activeTab={activeTab} setActiveTab={setActiveTab} onLogout={logout} />
            </div>
          }
          rightSlot={<TopUserActions currentUser={currentUser} onLogout={logout} onRefresh={refreshCurrentUser} />}
        />
