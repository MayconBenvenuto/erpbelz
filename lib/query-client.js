...
export const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      // Cache por 10 minutos por padrão para minimizar refetch ao trocar de aba
      staleTime: 10 * 60 * 1000,
      // Manter cache por 20 minutos após ficar stale
      gcTime: 20 * 60 * 1000,
      ...
      // Suaviza troca de filtros/abas mantendo dado anterior
      keepPreviousData: true,
      placeholderData: (prev) => prev,
      // Assume disponibilidade de rede até falhar (menos bloqueios)
      networkMode: 'online',
    },
    mutations: {
...
export const queryKeys = {
  ...
  // Reports
  reports: ['reports'],
  reportsPerformance: (start, end) => ['reports', 'performance', start, end],
